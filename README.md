...
directory does a lot of that for you. You would run it like so:
    ...
    go get github.com/chrnorm/oapi-codegen/cmd/oapi-codegen
...
import (
	...
	"github.com/chrnorm/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/chrnorm/oapi-codegen/pkg/gin-middleware"
)
...
```
    import (
        "github.com/chrnorm/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/chrnorm/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  - skip-prune
import-mapping:
  ./packageA/spec.yaml: github.com/chrnorm/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/chrnorm/oapi-codegen/internal/test/externalref/packageB
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/chrnorm/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48)
